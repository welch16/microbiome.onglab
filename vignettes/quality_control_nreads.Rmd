...
We included few functions to quantify the samples' quality by summarizing the amount of reads in every step of the pipeline. The main function that summarize the read abundance for each samples is:
