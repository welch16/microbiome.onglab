...
there is a function that generates an associated [condor](https://research.cs.wisc.edu/htcondor/) file. For example, the function `condor_filter_trim` is associated to the `filter_and_trim_pairs.R` script, and would generate
