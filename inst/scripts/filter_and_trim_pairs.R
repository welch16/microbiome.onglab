...
if (!file.exists(out_file)) {
  out <- dada2::filterAndTrim(
    ...
    truncQ = micrbiome.onglab::get_param_filter_trim("truncQ", params),
    truncLen = micrbiome.onglab::get_param_filter_trim("truncLen", params),
    trimLeft = micrbiome.onglab::get_param_filter_trim("trimLeft", params),
    trimRight = micrbiome.onglab::get_param_filter_trim("trimRight", params),
    maxLen = micrbiome.onglab::get_param_filter_trim("maxLen", params),
    minLen = micrbiome.onglab::get_param_filter_trim("minLen", params),
    maxN = micrbiome.onglab::get_param_filter_trim("maxN", params),
    minQ = micrbiome.onglab::get_param_filter_trim("minQ", params),
    maxEE = micrbiome.onglab::get_param_filter_trim("maxEE", params),
    rm.phix = TRUE,
    compress = TRUE,
    multithread = TRUE)
