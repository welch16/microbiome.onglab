  ...
  writeLines(
    c(
      ...
      stringr::str_c("output           = $(outdir)/out/",
        "dada2_error_rates_$(cluster).$(process)_$(outprefix).out"),
      stringr::str_c("error            = $(outdir)/err/",
        "dada2_error_rates_$(cluster).$(process)_$(outprefix).err"),
      stringr::str_c("log              = $(outdir)/log/",
        "dada2_error_rates_$(cluster).$(process)_$(outprefix).log"),
