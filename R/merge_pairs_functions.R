  ...
  writeLines(
    c( "universe         = vanilla",
      ...
      stringr::str_c("output           = $(outdir)/out/",
        "dada2_merge_pairs_$(sample_name).$(cluster).$(process).out"),
      stringr::str_c("error            = $(outdir)/err/",
        "dada2_merge_pairs_$(sample_name).$(cluster).$(process).err"),
      stringr::str_c("log              = $(outdir)/log/",
        "dada2_merge_pairs_$(sample_name).$(cluster).$(process).log"),
